// EventDetailPage.jsx - Enhanced with Framer Motion & Modern Design
import React, { useState, useEffect } from 'react';
import axios from 'axios';
import { useParams, useNavigate } from 'react-router-dom';
import { motion, AnimatePresence } from 'framer-motion';
import {
    FiCalendar, FiMapPin, FiTag, FiDollarSign, FiUsers,
    FiInfo, FiArrowLeft, FiX, FiMaximize2, FiShoppingCart,
    FiClock, FiCheck, FiGrid
} from 'react-icons/fi';
...
const EventDetailsPage = () => {
    ...
    // Seat availability state for theater events
    ...
    // Fetch seat availability for theater events
    useEffect(() => {
            ...
            const fetchSeatData = async () => {
                try {
                    ...
                    const response = await axios.get(
                        `http://localhost:3000/api/v1/booking/event/${event._id}/seats`,
                        { withCredentials: true }
                    );
