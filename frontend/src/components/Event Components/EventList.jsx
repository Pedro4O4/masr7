// EventList.jsx - Enhanced with Framer Motion Animations
import React, { useState, useEffect } from 'react';
import axios from 'axios';
import { Link, useNavigate } from 'react-router-dom';
import { motion, AnimatePresence } from 'framer-motion';
import { FiSearch, FiCalendar, FiUser, FiArrowRight, FiGrid, FiList } from 'react-icons/fi';
                ...
                >
                    ...
                    <div className="actions-bar">
                        ...
                        <div className="action-buttons">
                            {user?.role === "Organizer" && (
                                <Link to="/my-events" className="action-btn primary">
                                    <FiCalendar />
                                    <span>My Events</span>
                                </Link>
                            )}
